...
/* SIZE : 15ko               */
/* loop frequency : 215KHz   */
/* loop frequency : 100ev/s	 */
/* last test      :     		 */
/* ev							:	    		 */
/* timers	(-110)	:	  	     */
/* overflow				:	  			 */
...
#define EVENT_STABILISATION 12

// fr?quencies
#define FREQUENCY_CPU_ANALYSER FREQUENCY_5Hz

#define FREQUENCY_GETTING_MPU_VALUES FREQUENCY_10Hz
#define FREQUENCY_CALCULATING_EULER_ANGLES FREQUENCY_10Hz

#define FREQUENCY_GETTING_HMC_VALUES FREQUENCY_5Hz
#define FREQUENCY_CALCULATING_HEADING FREQUENCY_5Hz

#define FREQUENCY_UPDATE_LED_POSITION FREQUENCY_50Hz

#define FREQUENCY_SERIAL_INPUT_LISTENER FREQUENCY_20Hz

#define FREQUENCY_DISPLAYING_EULER_ANGLES FREQUENCY_5Hz
#define FREQUENCY_DISPLAYING_SYSTEM_INFORMATION FREQUENCY_5Hz
#define FREQUENCY_DISPLAY_SENSORS_VALUES FREQUENCY_5Hz

#define FREQUENCY_STABILISATION FREQUENCY_50Hz
